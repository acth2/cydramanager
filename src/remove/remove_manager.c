...
#include "src/arguments/debug/debug.h"
#include <dirent.h>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
bool remove_software(char *package_name) {
    ...
    if (is_empty(check_installed_software) || !package_directory) {
    ...
    FILE *db_write = fopen("/etc/cydramanager.d/usdb_temp", "w");
    ...
    rename("/etc/cydramanager.d/usdb_temp", "/etc/cydramanager.d/usdb");
